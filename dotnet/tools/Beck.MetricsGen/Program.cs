...
// EmbeddedMetricsMeasurer reads (dotnet/Beck/Text/*MetricsData.g.cs). Each table mirrors
...
//
// <outputDir> defaults to dotnet/Beck/Text (resolved from this file's path). Do not add to CI.
...
static string Emit(Family fam, int[] extras, (int W, string File)[] mono, string monoDir)
{
    ...
    sb.AppendLine("//   the Beck.MetricsGen console (dotnet/tools/Beck.MetricsGen). Do not edit by hand.");
    sb.AppendLine("// </auto-generated>");
